...
import com.jpeng.jptabbar.R;
import com.mobile.jptabbar.anno.NorIcons;
import com.mobile.jptabbar.anno.SeleIcons;
import com.mobile.jptabbar.anno.Titles;
import com.mobile.jptabbar.animate.Animatable;
import com.mobile.jptabbar.animate.FlipAnimater;
import com.mobile.jptabbar.animate.JumpAnimater;
import com.mobile.jptabbar.animate.RotateAnimater;
import com.mobile.jptabbar.animate.ScaleAnimater;
...
public class JPTabBar extends LinearLayout implements ViewPager.OnPageChangeListener {
    ...
    //默认的图标大小
    private static final int DEFAULT_ICONSIZE = 21;
    //字体默认大小
    ...
    //默认的选中颜色
    private static final int DEFAULT_SELECT_COLOR = 0xffE9413D;
    //默认是否接受颜色随着字体变化
